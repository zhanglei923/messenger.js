...
e=0;e<b.length;e++)a.from="parent",b[e].contentWindow.postMessage({messengerjs:a},"*");"child"===a.from&&window!==parent&&(a.from="child",window.parent.postMessage({messengerjs:a},"*"))};a.subscribe=function(a,b){a=md5_util(a);d[a]=b};a.stopSubscribe=function(a){a=md5_util(a);delete d[a]};window.addEventListener?window.addEventListener("message",f):window.attachEvent&&window.attachEvent("onmessage",f);("listening...")})(messenger);;window.messenger=messenger;})();