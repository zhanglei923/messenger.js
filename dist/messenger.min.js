...
document.getElementsByTagName("iframe"),d=0;d<b.length;d++)a.from="parent",b[d].contentWindow.postMessage({messengerjs:a},"*");"child"===a.from&&window!==parent&&(a.from="child",window.parent.postMessage({messengerjs:a},"*"))};a.subscribe=function(a,b){a=md5_util(a);c[a]=b};a.stopSubscribe=function(a){a=md5_util(a);delete c[a]};window.addEventListener?window.addEventListener("message",f):window.attachEvent&&window.attachEvent("onmessage",f);("listening...")})(messenger);;window.messenger=messenger;
})();