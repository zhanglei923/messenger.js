            ...
            if (iframe.win.postMessage) {
                ...
                iframe.win.postMessage({
                    messengerjs: {
                        ...
                        eventName: eventName, //请求的名字
                        args: args, //本次请求的参数
                        responseToken: responseToken, //本次请求的token，一次性
...
(function (messenger) {
    ...
    var handleRequest = function handleRequest(data) {
        //console.log('on msg', window.location.href, data)
        var data = data.data;
    ...
    var doResponse = function doResponse(responseToken, result) {
